...
```bash
python3 ~/.agents/skills/meta-ads-ratos/scripts/setup.py
```

### 2. Verificar .env

Checar se existe `~/.agents/skills/meta-ads-ratos/.env`. Se NAO existir, criar com o template:
...
**Arquivo:** `~/.agents/skills/meta-ads-ratos/contas.yaml`
...
Todos os scripts estao em `~/.agents/skills/meta-ads-ratos/scripts/`. O padrao e:
...
**Arquivo:** `aprendizados.md` (na raiz da skill, `~/.agents/skills/meta-ads-ratos/aprendizados.md`)
